...
func (x *MigrationHeader) GetCephFsid() string {
	if x != nil && x.CephFsid != nil {
		return *x.CephFsid
	}
	return ""
}

func (x *MigrationHeader) GetCephPool() string {
	if x != nil && x.CephPool != nil {
		return *x.CephPool
	}
	return ""
}

func (x *MigrationHeader) GetSharedStorage() bool {
	if x != nil && x.SharedStorage != nil {
...
type MigrationControl struct {
	...
	// confirms that a failed target released any shared storage claim
	SharedStorageReleased *bool `protobuf:"varint,3,opt,name=sharedStorageReleased" json:"sharedStorageReleased,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *MigrationControl) GetSharedStorageReleased() bool {
	if x != nil && x.SharedStorageReleased != nil {
		return *x.SharedStorageReleased
	}
	return false
}
...
const file_internal_migration_migrate_proto_rawDesc = "" +
	...
	"\x15sharedStorageReleased\x18\x03 \x01(\bR\x15sharedStorageReleased\"3\n" +
	"\rMigrationSync\x12\"\n" +
